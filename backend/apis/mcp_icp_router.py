...
#     # discovery can take longer (LLM calls, DB work); raise timeout to 120s
...
class DiscoverICPRequest(BaseModel):
    # No `product` field — ICP always analyzes the user's already
    # saved product/service. Use the sidebar switcher to change it.
    user_id: int
    country_id: Optional[int] = None
    industry_id: Optional[int] = None
